...
The first challenge is to access streamflow data. The `aae.data` package (hopefully) makes this easy. It links directly to the Vicwater/WMIS database to download flow from any gauge for any years. Getting data from R looks a bit like this:
